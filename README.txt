...
For the smallest possible filesize, a custom mootools.js is reccomended from the mootools.com site.
The mootools core modules required by this version of Picbox are:
- Native: all
- Class: all
- Element: all
- Utilities: DomReady
...
Note that unlike older versions picbox no longer requires the 'Drag' module from mootools more.
